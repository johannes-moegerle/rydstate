...
class MQDTStrontium87(MQDT):
    ...
    # Note that this Sr87 value differs from the Sr88 ionization threshold by the isotope shift (0.0046 1/cm).
...
class MQDTStrontium88(MQDT):
    ...
    # 1377012721 MHz = 45932.2002 1/cm
    # same as is used in the Addendum of Vaillant et al. 2024 (https://doi.org/10.1088/1361-6455/ad76f0)
