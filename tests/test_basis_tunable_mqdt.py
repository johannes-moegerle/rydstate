...
def test_scaled_off_diagonal_model_only_scales_the_coupling(model: MQDTModel) -> None:
...
def test_scaled_off_diagonal_model_is_transparent_for_scale_one(model: MQDTModel) -> None:
